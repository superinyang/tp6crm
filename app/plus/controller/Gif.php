...
class Gif
{
    ...
    public function GIFAddHeader()
    {
        ...
        if (ord($this->BUF[0]{
            ...
            $this->GIF .= "!\377\13NETSCAPE2.0\3\1" . Gif::GIFWord($this->LOP) . "\0";
        }
    }
    ...
    public function GIFAddFrames($i, $d)
    {
        ...
        if (ord($this->BUF[$i]{
            ...
            if ($Global_len == $Locals_len) {
                if (Gif::GIFBlockCompare($Global_rgb, $Locals_rgb, $Global_len)) {
